    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Image.asset(
            isBit
                ? "asset/icon/ic_crypto_btc.png"
                : "asset/icon/ic_crypto_eth.png",
            width: 40,
            height: 40,
            fit: BoxFit.cover,
          ),
          ...
          Column(
            ...
            children: [
              ...
              Chip(
                label: TextView()
                    .textDefault(text: "+0.44%", textColor: ResColor.TEXT_CHIP),
                backgroundColor:
                    isDown ? ResColor.BG_CHIP_DOWN : ResColor.BG_CHIP_UP,
              )
            ],
          )
        ],
